...
Lankomumo žymėjimas yra pasikartojantis ir toks pat procesas, kurį galima visiškai automatizuoti. Taip būtų supaprastinamas dėstytojų darbas bei taupomas laikas. Lankomumo žymėjimą galima automatizuoti ne vienu būdu, tačiau pirmiausia reikia susieti studento išmanųjį telefoną su jo vardu ir pavarde, esančias dėstytojo sąraše. Yra du būdai - nfc ir bluetooth
...
Pateikti būdai turi ir privalumų, ir trūkumų. Visgi tinkamesnis būdas identifikuoti studentus yra pasitelkus Bluetooth technologiją, nes: nepriklausoma nuo trečiųjų šalių paslaugų (services); auditorijose reikia įrengti mažiau skaitytuvų ir / ar greitesnis identifikavimas (nesusidaro eilės prie skaitytuvų); šie būdai papildo vienas kitą - jei tel išsikrovęs, tai tinka lsp; jei lsp pamiršai - turi telefoną.
