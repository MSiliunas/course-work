...
\title{Lankomumo žymėjimas, panaudojant studentų išmaniuosius telefonus}
\titleineng{Attendance marking with student smartphones}
...
Verta paminėti, kad šie būdai nėra priešinami, o laikomi alternatyvomis. Jei telefonas išsikrovęs, galima būtų identifikuoti su LSP. Jei LSP studentas pamiršo pasiimti į užsiėmimą - galime identifikuoti su studento išmaniuoju telefonu.
...
Pagal pateiktą \textit{UML} sistemos komponentų diagramą (\ref{img:componentDiagram} pav.) matome, kad sistemą sudaro keturi pagrindiniai komponentai — studento ir dėstytojo telefonai, serveris bei naudotojo kompiuteris. Pažymėtina tai, kad serveris savyje turi du komponentus — saityno programų programavimo sąsają ir administravimo aplinką.
...
Hibridinė programėlė - tai saityno programėlė, tačiau integruota į 	savą programėlę. Tai suteikia galimybę priėjimą prie įrenginio operacinės sistemos programų programavimo sąsajos. Tokiu būdu mes galime pasiekti išmaniojo įrenginio resursus, o šiuo atveju - mums reikalingą \textit{Bluetooth} modulį.
